    ...
    <React.Fragment>
      ...
      >
        <div className="relative flex size-full items-center justify-center">
          <svg
            className="size-full transition-all group-hover:-translate-0.5 group-hover:scale-105 group-hover:opacity-70"
            viewBox="0 0 300 300"
          >
            <line
              className="fill-none stroke-[#f43f5e] stroke-[3.67px] [stroke-linecap:round] [stroke-linejoin:round]"
              x1="63.43"
              y1="263.02"
              x2="83.01"
              y2="243.45"
            ...
            />
            <line
              className="fill-none stroke-[#f43f5e] stroke-[3.67px] opacity-28 [stroke-linecap:round] [stroke-linejoin:round]"
              x1="187.58"
              y1="138.87"
              x2="206.63"
              y2="119.82"
            ...
            />
            <path
              className="origin-center animate-spin fill-[#f43f5e] [animation-duration:3700ms] transform-fill group-hover:[animation-duration:1000ms]"
