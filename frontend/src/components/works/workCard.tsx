...
export default function WorkCard({
  ...
  return (
    ...
    >
      <div
        className={`${isHovered ? "-top-8" : "-top-9"} pointer-events-none absolute z-3 max-w-full rounded-xl bg-[#6354eb] px-3 py-1 text-sm whitespace-nowrap text-white drop-shadow-sm drop-shadow-[#a39ed1] transition-all duration-100 select-none before:absolute before:top-0 before:left-[50%] before:-z-1 before:block before:translate-x-[-50%] before:translate-y-full before:border-[22px_10px_0px_10px] before:border-x-transparent before:border-t-[#6354eb] before:content-['']`}
      >
